...
class Rails::Application < ::Rails::Engine
  ...
  # source://railties/7.1.3.4/lib/rails/application.rb#437
  def config; end

  # source://railties/7.1.3.4/lib/rails/application.rb#441
  def config=(_arg0); end

  # source://railties/7.1.3.4/lib/rails/application.rb#274
  def config_for(name, env: T.unsafe(nil)); end

  # source://railties/7.1.3.4/lib/rails/application.rb#357
  def console(&blk); end

  # source://railties/7.1.3.4/lib/rails/application.rb#516
  def credentials; end

  # source://railties/7.1.3.4/lib/rails/application.rb#460
  def credentials=(_arg0); end

  # source://railties/7.1.3.4/lib/rails/application.rb#104
  def default_url_options(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.1.3.4/lib/rails/application.rb#104
  def default_url_options=(arg); end

  # source://railties/7.1.3.4/lib/rails/application.rb#230
  def deprecators; end

  # source://railties/7.1.3.4/lib/rails/application.rb#574
  def eager_load!; end

  # source://railties/7.1.3.4/lib/rails/application.rb#535
  def encrypted(path, key_path: T.unsafe(nil), env_key: T.unsafe(nil)); end

  # source://railties/7.1.3.4/lib/rails/application.rb#303
  def env_config; end

  # source://railties/7.1.3.4/lib/rails/application.rb#102
  def executor; end

  # source://railties/7.1.3.4/lib/rails/application.rb#363
  def generators(&blk); end

  # source://railties/7.1.3.4/lib/rails/application.rb#548
  ...
  # source://railties/7.1.3.4/lib/rails/application.rb#424
  def initialize!(group = T.unsafe(nil)); end

  # source://railties/7.1.3.4/lib/rails/application.rb#134
  def initialized?; end

  # source://railties/7.1.3.4/lib/rails/application.rb#345
  def initializer(name, opts = T.unsafe(nil), &block); end

  # source://railties/7.1.3.4/lib/rails/application.rb#431
  def initializers; end

  # source://railties/7.1.3.4/lib/rails/application.rb#374
  def isolate_namespace(mod); end

  # source://railties/7.1.3.4/lib/rails/application.rb#161
  def key_generator(secret_key_base = T.unsafe(nil)); end

  # source://railties/7.1.3.4/lib/rails/application.rb#568
  def load_generators(app = T.unsafe(nil)); end

  # source://railties/7.1.3.4/lib/rails/application.rb#222
  def message_verifier(verifier_name); end

  # source://railties/7.1.3.4/lib/rails/application.rb#197
  def message_verifiers; end

  # source://railties/7.1.3.4/lib/rails/application.rb#564
  ...
  # source://railties/7.1.3.4/lib/rails/application.rb#153
  ...
  # source://railties/7.1.3.4/lib/rails/application.rb#400
  def require_environment!; end

  # source://railties/7.1.3.4/lib/rails/application.rb#405
  def routes_reloader; end

  # source://railties/7.1.3.4/lib/rails/application.rb#138
  def run_load_hooks!; end

  # source://railties/7.1.3.4/lib/rails/application.rb#351
  def runner(&blk); end

  # source://railties/7.1.3.4/lib/rails/application.rb#100
  def sandbox; end
  ...
  # source://railties/7.1.3.4/lib/rails/application.rb#478
  def secret_key_base; end

  # source://railties/7.1.3.4/lib/rails/application.rb#443
  def secrets; end

  # source://railties/7.1.3.4/lib/rails/application.rb#460
  def secrets=(_arg0); end

  # source://railties/7.1.3.4/lib/rails/application.rb#369
  def server(&blk); end

  # source://railties/7.1.3.4/lib/rails/application.rb#544
  def to_app; end

  # source://railties/7.1.3.4/lib/rails/application.rb#412
  def watchable_args; end

  protected

  # source://railties/7.1.3.4/lib/rails/application.rb#647
  def default_middleware_stack; end

  # source://railties/7.1.3.4/lib/rails/application.rb#662
  def ensure_generator_templates_added; end

  # source://railties/7.1.3.4/lib/rails/application.rb#613
  def ordered_railties; end

  # source://railties/7.1.3.4/lib/rails/application.rb#635
  def railties_initializers(current); end

  # source://railties/7.1.3.4/lib/rails/application.rb#602
  def run_console_blocks(app); end

  # source://railties/7.1.3.4/lib/rails/application.rb#592
  def run_generators_blocks(app); end

  # source://railties/7.1.3.4/lib/rails/application.rb#597
  def run_runner_blocks(app); end

  # source://railties/7.1.3.4/lib/rails/application.rb#607
  def run_server_blocks(app); end

  # source://railties/7.1.3.4/lib/rails/application.rb#581
  def run_tasks_blocks(app); end

  # source://railties/7.1.3.4/lib/rails/application.rb#652
  def validate_secret_key_base(secret_key_base); end

  private

  # source://railties/7.1.3.4/lib/rails/application.rb#700
  def build_middleware; end

  # source://railties/7.1.3.4/lib/rails/application.rb#693
  def build_request(env); end

  # source://railties/7.1.3.4/lib/rails/application.rb#704
  def coerce_same_site_protection(protection); end

  # source://railties/7.1.3.4/lib/rails/application.rb#708
  def filter_parameters; end

  # source://railties/7.1.3.4/lib/rails/application.rb#668
  def generate_local_secret; end

  # source://railties/7.1.3.4/lib/rails/application.rb#687
  def secrets_secret_key_base; end

  class << self
    # source://railties/7.1.3.4/lib/rails/application.rb#393
    def add_lib_to_load_path!(root); end

    # source://railties/7.1.3.4/lib/rails/application.rb#84
    def create(initial_variable_values = T.unsafe(nil), &block); end

    # source://railties/7.1.3.4/lib/rails/application.rb#88
    def find_root(from); end

    # source://railties/7.1.3.4/lib/rails/application.rb#71
    def inherited(base); end

    # source://railties/7.1.3.4/lib/rails/application.rb#80
    def instance; end
...
class Rails::Application::Configuration < ::Rails::Engine::Configuration
  ...
  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#14
  ...
  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#541
  def annotations; end

  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#28
  def api_only; end

  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#375
  ...
  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#473
  def autoload_lib(ignore:); end

  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#485
  ...
  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#387
  ...
  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#497
  def colorize_logging; end

  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#501
  ...
  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#546
  ...
  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#436
  def database_configuration; end

  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#391
  def debug_exception_response_format; end

  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#395
  def debug_exception_response_format=(_arg0); end

  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#563
  ...
  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#357
  def enable_dependency_loading; end

  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#362
  def enable_dependency_loading=(value); end

  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#343
  def enable_reloading; end

  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#347
  def enable_reloading=(value); end

  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#28
  def encoding; end

  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#367
  ...
  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#575
  def inspect; end

  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#418
  def load_database_yaml; end

  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#92
  ...
  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#382
  ...
  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#397
  def paths; end

  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#555
  ...
  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#339
  ...
  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#521
  def session_store(new_session_store = T.unsafe(nil), **options); end

  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#537
  ...
  # source://railties/7.1.3.4/lib/rails/application/configuration.rb#600
