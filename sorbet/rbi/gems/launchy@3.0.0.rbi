...
# application class
#
# source://launchy//lib/launchy.rb#21
module Launchy
  class << self
    # source://launchy//lib/launchy.rb#55
    def app_for_name(name); end

    # source://launchy//lib/launchy.rb#51
    def app_for_uri(uri); end

    # source://launchy//lib/launchy.rb#61
    ...
    # source://launchy//lib/launchy.rb#93
    def debug=(d); end
    ...
    # source://launchy//lib/launchy.rb#85
    ...
    #
    # source://launchy//lib/launchy.rb#27
    def open(uri_s, options = T.unsafe(nil), &error_block); end

    # source://launchy//lib/launchy.rb#135
    def path; end

    # source://launchy//lib/launchy.rb#139
    def path=(path); end

    # source://launchy//lib/launchy.rb#77
    def reset_global_options; end

    # @raise [Launchy::ArgumentError]
    #
    # source://launchy//lib/launchy.rb#65
    def string_to_uri(s); end

    private

    # source://launchy//lib/launchy.rb#144
    def to_bool(arg); end
  end
end
...
class Launchy::Application
  ...
  #
  # source://launchy//lib/launchy/application.rb#63
  def initialize; end

  # source://launchy//lib/launchy/application.rb#68
  def find_executable(bin, *paths); end

  # Returns the value of attribute host_os_family.
  #
  # source://launchy//lib/launchy/application.rb#60
  def host_os_family; end

  # source://launchy//lib/launchy/application.rb#72
  def run(cmd, *args); end

  # Returns the value of attribute runner.
  #
  # source://launchy//lib/launchy/application.rb#61
  def runner; end
  ...
  class << self
    ...
    #
    # source://launchy//lib/launchy/application.rb#39
    def find_executable(bin, *paths); end
    ...
    #
    # source://launchy//lib/launchy/application.rb#30
    ...
    # @return [Boolean]
    #
    # source://launchy//lib/launchy/application.rb#55
...
class Launchy::Cli
  ...
  # source://launchy//lib/launchy/cli.rb#61
  ...
  # source://launchy//lib/launchy/cli.rb#54
...
# source://launchy//lib/launchy/runner.rb#3
class Launchy::Runner
  # source://launchy//lib/launchy/runner.rb#39
  def commandline_normalize(cmdline); end

  # source://launchy//lib/launchy/runner.rb#24
  def dry_run(cmd, *args); end

  # @raise [Launchy::CommandNotFoundError]
  #
  # source://launchy//lib/launchy/runner.rb#4
  def run(cmd, *args); end
  ...
  # source://launchy//lib/launchy/runner.rb#13
