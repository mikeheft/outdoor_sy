...
class Mail::PartsList < Anonymous_Delegator_6
  def attachments; end
  def collect!; end
  def collect; end
...
class Mail::CommonAddressField < Mail::NamedStructuredField
  ...
  def each; end
  def element; end
  def encode_if_needed(val, val_charset = nil); end
...
class Mail::BccField < Mail::CommonAddressField
  ...
  def include_in_headers=(arg0); end
  def initialize(value = nil, charset = nil); end
end
class Mail::CommonMessageIdField < Mail::NamedStructuredField
  ...
  def do_encode; end
  def element; end
  def formatted_message_ids(join = nil); end
  def message_id; end
  def message_ids; end
  def to_s; end
end
...
module Mail::CheckDeliveryParams
  ...
  def self.check(*args, **, &block); end
  def self.check_addr(*args, **, &block); end
  def self.check_from(*args, **, &block); end
  def self.check_message(*args, **, &block); end
  def self.check_to(*args, **, &block); end
  def self.validate_smtp_addr(*args, **, &block); end
end
