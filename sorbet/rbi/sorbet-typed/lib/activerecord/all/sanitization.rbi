...
module ActiveRecord::Sanitization::ClassMethods
  ...
  sig do
    params(assignments: T.any(T::Array[T.untyped], T::Hash[T.untyped, T.untyped], String),
           default_table_name: String).returns(String)
  end
  def sanitize_sql_for_assignment(assignments, default_table_name = table_name); end
  ...
  def sanitize_sql_like(string, escape_character = '\\'); end
