...
# Please instead update this file by running `bin/tapioca dsl Owner`.
...
class Owner
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Owner).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.any(Integer, Float, BigDecimal)) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::Owner).void)).returns(::Owner) }
    ...
    sig { params(column_name: NilClass, block: T.proc.params(object: ::Owner).void).returns(Integer) }
    ...
    sig do
      ...
      ).returns(T::Enumerable[::Owner])
    end
    sig { params(args: NilClass, block: T.proc.params(object: ::Owner).void).returns(T.nilable(::Owner)) }
    def find(args = nil, &block); end

    sig { params(args: T.untyped).returns(T.nilable(::Owner)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::Owner) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.proc.params(object: ::Owner).void
      ).void
    end
    sig do
      params(
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.proc.params(object: T::Array[::Owner]).void
      ).void
    end
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[T::Enumerator[::Owner]])
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::Owner)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::Owner) }
    def find_signed!(signed_id, purpose: nil); end

    sig { params(arg: T.untyped, args: T.untyped).returns(::Owner) }
    def find_sole_by(arg, *args); end

    sig { params(limit: NilClass).returns(T.nilable(::Owner)) }
    ...
    sig do
      type_parameters(:U)
        .params(
          ...
          block: T.proc.params(object: ::Owner).returns(T.type_parameter(:U))
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Owner` class because it declared `has_many :vehicles`.
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Owner, T::Enumerable[T.any(::Owner, T::Enumerable[::Owner])])
    ...
    sig do
      params(
        records: T.any(::Owner, Integer, String, T::Enumerable[T.any(::Owner, Integer, String, T::Enumerable[::Owner])])
      ).returns(T::Array[::Owner])
    end
    ...
    sig do
      params(
        other_array: T.any(::Owner, T::Enumerable[T.any(::Owner, T::Enumerable[::Owner])])
      ).returns(T::Array[::Owner])
    end
